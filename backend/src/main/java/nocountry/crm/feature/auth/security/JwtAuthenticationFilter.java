    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                // Obtenemos el usuario de DB para validar estado (isActive, deletedAt)
            ...
            // Token inválido o expirado. El contexto de seguridad quedará null y SecurityConfig lo bloqueará.
